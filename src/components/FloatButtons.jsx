    ...
    return (
        <>
            ...
            <a
                ...
                title="WhatsApp Us"
                aria-label="Chat with B2P International on WhatsApp"
            >
                <svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7 md:w-8 md:h-8" viewBox="0 0 448 512" aria-hidden="true">
            ...
            >
                <Phone className="w-6 h-6 md:w-8 md:h-8" aria-hidden="true" />
            </a>
        </>
    );
};
