        ...
        <div className="bg-slate-50 min-h-screen">
            ...
            <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 bg-[#050914] overflow-hidden min-h-[80vh] flex flex-col justify-center">
                ...
                <div className="container mx-auto px-6 max-w-7xl relative z-10 text-center flex flex-col items-center">
                    ...
                    >
                        Mobile <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-primary to-brand-secondary">LED Van Advertising</span> Services for Events & Promotions
                    </motion.h1>
                    ...
                    >
                        Capture attention effortlessly. Our dynamic mobile billboards offer unmatched visibility, taking your brand straight to the audience where they live, work, and play.
                    </motion.p>
